...
const ExploreSearch = ({countries}) => {
    ...
    return(
        ...
        <Grid templateColumns={{base:'',xmd:'repeat(3,1fr)',md:'repeat(4,1fr)',slg:'repeat(3,1fr)',lg:'repeat(4,1fr)',xl:'repeat(4,1fr)'}} gap='4' p='2rem' mt='rem' ml={{base:'-1rem',xxm:'0.5rem',xm:'1.2rem',sm:'2rem',xmd:'-0.1rem',md:'rem',slg:'14rem',lg:'9rem',xl:'11rem',dm:'11.9rem',xxl:'14rem'}}>
                {filteredCountries.map(count => (
                  <Link to={`/exploreCountryDetails/${count.name.common}`}>
                    <Card maxW='sm' borderWidth='1px' borderColor='' height={{base:'33vh',xxm:'24vh',xm:'24vh',sm:'22vh',xmd:'20vh',md:'22vh',slg:'27vh',lg:'22vh',xl:'22vh'}} width={{base:'18rem',xm:'18rem',sm:'18rem',xmd:'12rem',md:'10rem',slg:'13rem',lg:'15.7rem',xl:'16rem',dm:'15rem'}} key={count.name}>
