...
const ExploreCountryDetails = () => {
    ...
    return(
        ...
        {clickedCountry.map((count) => {
            return <Card borderWidth='1px' width={{base:'50rem',md:'60rem',slg:'35rem',lg:'50rem',xl:'50rem',dm:'59rem'}} ml={{base:'rem',md:'',slg:'14rem',lg:'15.5rem',xl:'21rem',dm:'29rem',xxl:'28rem'}} mt={{base:'3rem',xmd:'8rem',md:'10rem',slg:'1rem',lg:'3rem',xl:'3rem',xxl:'9rem'}} height={{base:'130vh',xxm:'105vh',xm:'100vh',sm:'105vh',xmd:'75vh',md:'70vh',slg:'115vh',lg:'91vh',xl:'90vh',xxl:'70vh'}} >
