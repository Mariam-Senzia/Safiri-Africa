        ...
        <>
          <Box bgColor={{base:'',md:'#F5F5F5',slg:'#F5F5F5',lg:'#F5F5F5',xl:'#F5F5F5'}} height={{base:'',md:'',slg:'100vh',lg:'100vh',xl:''}} width={{base:'100vw',xxm:'100vw',md:'100vw',slg:'39vh',lg:'24vw',xl:''}} position='fixed' zIndex={{base:'10',md:'',lg:'',xl:''}} >
           ...
           <Box display={{base:'flex',md:'flex',slg:'block',lg:'block',xl:'block'}} mt={{base:'',md:'',lg:'',xl:'-1rem'}} bgColor={{base:'#E0E0E1',md:'#E0E0E1',slg:'#F5F5F5',lg:'#F5F5F5',xl:'#F5F5F5'}} p={{base:'1rem',md:'',lg:'',xl:''}} justifyContent='space-between'>
            <Flex ml={{base:'rem',xxmd:'1.5rem',md:'1.5rem',slg:'',lg:'40px',xl:''}}>
            ...
            {/* tablet display */}
            <Box display={{base:'none',xmd:'flex',md:'flex',slg:'none',lg:'none',xl:'none'}} >
            <Link to='/homeDefault'>
            ...
            <IconButton icon={<HamburgerIcon/>} display={{base:'',xmd:'none',md:'none',slg:'none',lg:'none',xl:'none'}} ml={{base:'rem',md:'30rem'}} onClick={onOpen} bgColor='#DCE0E5'/>
            </Box> 
            ...
            <Box display={{base:'none',md:'none',slg:'block',lg:'block',xl:'block'}}>
                ...
                <Divider borderWidth={'1px'}/>
                <Link to='/explore'>
                <Text p={{base:'',md:'',slg:'1rem',lg:'1rem',xl:'',xxl:'2.5rem'}} _hover={{color:'#FF4500'}} ml={{base:'',md:'',lg:'1.5rem',xl:''}}>Explore</Text>
                </Link>

                <Divider borderWidth={'1px'} />
                <Link to='/profile'>
                <Text p={{base:'',md:'',slg:'1rem',lg:'1rem',xl:'',xxl:'2.5rem'}} _hover={{color:'#FF4500'}} ml={{base:'',md:'',lg:'1.5rem',xl:''}}>Profile</Text>
                </Link>
