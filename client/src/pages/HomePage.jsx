    ...
    return (
        ...
        <Box >
            ...
            <Flex justifyContent='' mt={{base:'1rem',md:'',lg:'',xl:'4rem',xxl:'8rem'}} >
               <Box width={{base:'18rem',xmd:'32rem',md:'30rem',slg:'25rem',lg:'',xl:'30rem'}} ml={{base:'1rem',xxm:'3rem',xm:'3.5rem',sm:'4.5rem',xmd:'10rem',md:'11rem',slg:'3rem',lg:'5rem',xl:'6rem',dm:'7.2rem',xxl:'12rem'}} mt={{base:'rem',xxm:'2rem',xm:'1rem',sm:'2rem',xmd:'4rem',md:'6rem',slg:'8rem',lg:'9rem',xl:'9rem',xxl:'12rem'}}>
            ...
            <Box mt={{base:'3.5rem',md:'',lg:'-2rem',xl:'6rem'}} textAlign='center' ml='rem' mb={{base:'-2.5rem',md:'',lg:'',xl:''}} bgColor='#F5F5F5' p='1rem' width={{base:'',xxm:'',xm:'',sm:'',md:'',lg:'',xl:''}}>
                <Flex justifyContent='space-between' mt='2rem'>
                    ...
                    <Text>Comment</Text>
                    <Text mr={{base:'0.5rem',xmd:'4rem',md:'5rem',lg:'9rem',xl:'8.5rem',dm:'9.6rem',xxl:'15rem'}}>Share</Text>
                </Flex>
                
                <Flex justifyContent='space-between' mt='1rem' mb='2rem'>

                    <IconButton borderRadius='50px' width={{base:'3rem',xxm:'4rem',xm:'rem',sm:'',xmd:'4.5rem',md:'5.5rem',slg:'4rem',lg:'5rem',xl:'5rem',dm:'5.5rem',xxl:'6rem'}} height={{base:'9vh',xxm:'8vh',xm:'',sm:'',md:'',slg:'10vh',lg:'10vh',xl:'11vh',xxl:'10vh'}} ml={{base:'rem',xxm:'-0.5rem',xm:'rem',sm:'rem',xmd:'3rem',md:'4rem',lg:'6.5rem',xl:'6.5rem',dm:'8rem',xxl:'13rem'}} bgColor='#EF233C'>
                        <BiLike color='white' fontSize={{base:'rem',md:'rem',lg:'2rem',xl:'2rem'}}/>
                    </IconButton>

                    <IconButton borderRadius='50px'  width={{base:'3rem',xxm:'4rem',xm:'',sm:'rem',xmd:'4.5rem',md:'5.5rem',slg:'4rem',lg:'5rem',xl:'5rem',dm:'5.5rem',xxl:'6rem'}} height={{base:'9vh',xxm:'8vh',xm:'',sm:'',md:'',slg:'10vh',lg:'10vh',xl:'11vh',xxl:'10vh'}} bgColor='#00F0B5'>
                        <BiComment color='white  ' fontSize={{base:'rem',md:'',lg:'2rem',xl:'2rem'}}/>
                    </IconButton>
                    
                    <IconButton mr={{base:'rem',xxm:'-0.5rem',xm:'rem',sm:'rem',xmd:'3rem',md:'3.8rem',slg:'4.3rem',lg:'8rem',xl:'7rem',dm:'8rem',xxl:'13rem'}} borderRadius='50px'  width={{base:'3rem',xxm:'4rem',xm:'rem',sm:'rem',xmd:'4.5rem',md:'5.5rem',slg:'4rem',lg:'5rem',xl:'5rem',dm:'5.5rem',xxl:'6rem'}} height={{base:'9vh',xxm:'8vh',xm:'',sm:'',md:'',slg:'10vh',lg:'10vh',xl:'11vh',xxl:'10vh'}} bgColor='#52D1DC'>
            ...
            <Box bgColor='#484349' mt='6rem'>
                <Flex justifyContent='space-between' p='2rem'>
                    ...
                    <Box color='white' ml={{base:'-20.8rem',xxm:'-24rem',xm:'-24.4rem',sm:'',xmd:'-32rem',md:'-35rem',slg:'4rem',lg:'1rem',xl:'2rem'}}>
