    ...
    return(
      <>
        ...
        <Box display={{base:'none',md:'none',slg:'block',lg:'block',xl:'block'}}>
          <Image src='https://i.pinimg.com/564x/6f/73/6e/6f736e3f397c68b5eb80f12306e3b66e.jpg' height={{slg:'100vh',lg:'100vh'}} width={{slg:'33rem',lg:'90rem',xl:'60.5rem',xxl:'75rem'}} mt={{lg:'0rem'}} ml={{slg:'-0.5rem',lg:'-16rem',xl:'-16rem',xxl:'-16rem'}} />
        ...
        <Box p={{base:'1rem',xmd:'2rem',md:'2rem',lg:'2rem',xl:'2rem'}} borderWidth={{base:'3px',xxm:'3px',xm:'3px',sm:'3px',xmd:'3px',md:'3px',slg:'0',lg:'0',xl:'0'}} width={{base:'20rem',xxm:'21.6rem',xm:'23.3rem',sm:'25rem',xmd:'37rem',md:'40rem',slg:'24rem',lg:'',xl:'25rem'}} ml={{base:'-0.5rem',xxm:'0rem',xm:'0rem',sm:'0rem',xmd:'5rem',md:'5.5rem',slg:'rem',lg:'-11rem',xl:'-5rem',xxl:'-10rem'}} mr={{base:'',md:'',slg:'4rem',lg:'4rem',xl:'-5rem',xxl:'-14rem'}} mt={{base:'5.4rem',xxm:'14.9rem',xm:'19rem',sm:'21.6rem',xmd:'29rem',md:'33rem',slg:'3.5rem',lg:'9rem',xl:'4.5rem',xxl:'11rem'}} borderRadius={{base:'10px',md:'10px',lg:'',xl:'0px'}}  bgColor='white' height={{base:'',md:'45vh',lg:'',xl:'80vh'}}>
